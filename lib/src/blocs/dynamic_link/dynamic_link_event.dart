...
abstract class DynamicLinkEvent with _$DynamicLinkEvent {
  ...
  const factory DynamicLinkEvent.deepLinkErrorEvent(
      {@required OnLinkErrorException error}) = DeepLinkErrorEvent;
  const factory DynamicLinkEvent.deepLinkReceived({@required Uri deepLink}) =
      DeepLinkReceived;
