  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MultiBlocProvider(
        providers: [
          BlocProvider<SubscriptionPlansBloc>(create: (BuildContext context) =>
              SubscriptionPlansBloc(
                  subscriptionPlansRepository: SubscriptionPlansRepository()),),
          BlocProvider<PaymentsBloc>(create: (BuildContext context) =>
              // todo multigym
              PaymentsBloc(gymRepository: GymProvider(), gymId: "aranha"),),
          ],
