...
void main() {
  test("toString test", () {
    ...
    TestGym testGym = TestGym(domain: "testDomain", host: "testHost", stripePublicKey: "testKey", requiredField: "required");
    print("New: $testGym");
  });
  ...
  test("equality test", () {
    ...
    TestGym testGym = TestGym(domain: "testDomain", host: "testHost", stripePublicKey: "testKey", requiredField: "required");
    TestGym testGymClone = TestGym(domain: "testDomain", host: "testHost", stripePublicKey: "testKey", requiredField: "required");
  ...
  test("pattern matching test", () {
    executePatternMatching(TestGym(domain: "testDomain", host: "testHost", requiredField: "required"));
...
void executePatternMatching(TestGym testGym) {
  ...
  testGym.maybeMap(
    (TestGym caseZero) => print("mapped case zero [$caseZero]"),
